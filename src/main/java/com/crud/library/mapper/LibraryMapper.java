...
public class LibraryMapper {
    ...
    public Borrowing mapToBorrowing(final BorrowingDto borrowingDto) {
        return new Borrowing(borrowingDto.getId(), borrowingDto.getItem(), borrowingDto.getReader(), borrowingDto.getBorrowedFrom(), borrowingDto.getBorrowedTo(), borrowingDto.isPaidForDamaged());
    }

    public BorrowingDto mapToBorrowingDto(final Borrowing borrowing) {
        return new BorrowingDto(borrowing.getId(), borrowing.getItem(), borrowing.getReader(), borrowing.getBorrowedFrom(), borrowing.getBorrowedTo(), borrowing.isPaidForDamaged());
    }
